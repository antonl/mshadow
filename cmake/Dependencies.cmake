...
if(USE_BLAS)
  ...
  if(BLAS STREQUAL "ATLAS")
    ...
    list(APPEND _mshadow_DEFINES STRINGS MSHADOW_USE_CBLAS=1;MSHADOW_USE_MKL=0)
  ...
  elseif(BLAS STREQUAL "MKL")
    ...
    list(APPEND _mshadow_DEFINES STRINGS MSHADOW_USE_CBLAS=0;MSHADOW_USE_MKL=1)
  else()
    message(FATAL_ERROR "Unrecognized blas option:" ${BLAS})
  endif()
else()
    list(APPEND _mshadow_DEFINES STRINGS MSHADOW_USE_CBLAS=0;MSHADOW_USE_MKL=0)
endif(USE_BLAS)
